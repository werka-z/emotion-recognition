...
to 144x144 before detection recovers more faces, and whether adding contrast enhancement (CLAHE)
...
The 4 conditions tested:
  ...
  up_no_cl      upscaled to 144x144
  up_cl         upscaled to 144x144, CLAHE applied
...
Output:
    ...
    Saves detection_counts.npy to ablation_results/clahe/ for use in plotting.
"""
